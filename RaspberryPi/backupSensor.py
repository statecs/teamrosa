#Backup script in case we run out of time
import time
import picamera
import os
import glob
...
#	lines= f.readlines()
#	f.close()
#fake temperature data since we have no thermal sensor
	return ["3b 01 4b 46 7f ff 05 10 54 : crc=54 YES", "3b 01 4b 46 7f ff 05 10 54 t=19687"]
...
#MAIN function
try:
#This version does not utilise the middle server. Instead it talks directly to the db.
